...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    ...
    console.log("🖼️ Avatar URL:", user?.avatar?.url);
  ...
  return (
    <>
      <main className="relative flex-1 p-6 pt-28 transition-all duration-700 md:ml-64">
        <Header />
        <div className="flex flex-col-reverse xl:flex-row">
          {/* LEFT SIDE */}
          <div className="flex-[2] flex-col gap-7 lg:flex-row flex lg:items-center xl:flex-col justify-between xl:gap-20 py-5">
            <div className="x1:flex-[4] flex items-end w-full content-center">
              <Pie
                data={data}
                options={{ count: 0 }}
          ...
          <div className="flex flex-[4] flex-col gap-7 lg:gap-16 lg:px-7 lg:py-5 justify-between xl:min-h-[85.5vh]">
            <div className="flex flex-col-reverse lg:flex-row gap-7 flex-[4]">
              <div className="flex flex-col gap-7 flex-1">
                <div className="flex items-center gap-3 bg-white p-5 max-h-[120] overflow-y-hidden rounded-lg transition hover:shadow-inner duration-300 w-full lg:max-w-[360px]">
            ...
            <div className="hidden xl:flex bg-white p-7 text-lg sm:text-xl xl:text-3xl 2xl:text-4xl min-h-52 font-semibold relative flex-[3] justify-center items-center rounded-2xl">
              ...
              <p className="text-gray-700 text-sm sm:text-lg absolute rigt-[35px] sm:right-[78px] bottom-[10px]">
                ~ REC Team
              </p>
            </div>
          </div>
